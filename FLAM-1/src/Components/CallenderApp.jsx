const CallenderApp = () => {
  return (
    <div className="callender-app">
      <div className="callender">
        <h1 className="heading">Callender</h1>
      ...
      <div className="events">
         <div className="event-popup">
            ...
            <textarea placeholder="Enter Event Text (Maximum 60 Character) "></textarea>
         ...
         <div className="event">
            ...
            <div className="event-text">Meeting with Jai</div>
